...
export class GerenciadorAutenticacaoService {
  ...
  private URL_BASE_API = environment.url_base_api.concat("/autenticacao");

  constructor( private httpClient: HttpClient ) { }

  public registrarLoginUsuario( usuarioSistemaModel: UsuarioSistemaModel ) : Observable<UsuarioSistemaModel> {
    return this.httpClient.post<UsuarioSistemaModel>(`${this.URL_BASE_API}/autenticar-login-usuario`, usuarioSistemaModel);
  }
